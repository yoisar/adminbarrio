      ...
      <div className='card shadow-none rounded-0'>
        <div className='card-header' id='kt_activities_header'>
          <h3 className='card-title fw-bolder text-gray-900'>
            {intl.formatMessage({ id: 'ACTIVITY.LOGS.TITLE', defaultMessage: 'Registros de Actividad' })}
          </h3>
        ...
        <div className='card-footer py-5 text-center' id='kt_activities_footer'>
          <Link to='/crafted/pages/profile' className='btn btn-bg-body text-primary'>
            {intl.formatMessage({ id: 'ACTIVITY.LOGS.VIEW_ALL', defaultMessage: 'Ver Todas las Actividades' })}
